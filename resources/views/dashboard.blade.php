    ...
    <div class="row flex-grow">
        ...
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Dine In</h6>
              <div class="mb-2">
            ...
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h3 class="mb-2">Active Tables: 16</h3>
                <div class="d-flex align-items-baseline">
                  <p class="text-success">
                    <span>Total Amount: ₹ 4,433</span>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Home Delivery</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Zomato</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">Swiggy</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
    ...
    <div class="row flex-grow">
      <div class="col-md-2 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">162</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h4 class="mb-2 text-danger">60% <i data-feather="arrow-down" class="icon-sm mb-1"></i></h4>
                <div class="d-flex align-items-baseline">
                  <p class="">
      ...
      <div class="col-md-2 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">₹ 4,60,955</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h4 class="mb-2 text-success">20% <i data-feather="arrow-up" class="icon-sm mb-1"></i></h4>
                <div class="d-flex align-items-baseline">
                  <p class="">
      ...
      <div class="col-md-2 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">₹ 4,04,479</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h4 class="mb-2 text-success">30% <i data-feather="arrow-up" class="icon-sm mb-1"></i></h4>
                <div class="d-flex align-items-baseline">
                  <p class="">
      ...
      <div class="col-md-2 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">₹ 3,15,928</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
      ...
      <div class="col-md-2 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">₹ 12,328</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h4 class="mb-2 text-success">10% <i data-feather="arrow-up" class="icon-sm mb-1"></i></h4>
                <div class="d-flex align-items-baseline">
                  <p class="">
      ...
      <div class="col-md-2 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-baseline">
              <h6 class="card-title mb-0">₹ 83,120</h6>
              <div class="mb-2">
                <span class="badge badge-danger">Live</span>
              </div>
            </div>
            <div class="row">
              <div class="col-12 col-md-12 col-xl-12">
                <h4 class="mb-2 text-success">60% <i data-feather="arrow-up" class="icon-sm mb-1"></i></h4>
                <div class="d-flex align-items-baseline">
                  <p class="">
